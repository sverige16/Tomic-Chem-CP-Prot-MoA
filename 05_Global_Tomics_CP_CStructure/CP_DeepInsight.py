...
class CP_DI_Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self,idx):
        ...
        #print(f' matrix: {compound_array}')
                    # extract classification using index
        #print(f' label: {label}')
        ...
        return tprofile, compound_array.float(), label_tensor.long() # returns 
        



# Create datasets with relevant data and labels
training_dataset_CPDI = CP_DI_Dataset(training_set, DI_train_tensor, df_train_labels, dict_moa)
valid_dataset_CPDI = CP_DI_Dataset(validation_set, DI_val_tensor, df_val_labels, dict_moa)
test_dataset_CPDI = CP_DI_Dataset(test_set, DI_test_tensor, df_test_labels, dict_moa)
