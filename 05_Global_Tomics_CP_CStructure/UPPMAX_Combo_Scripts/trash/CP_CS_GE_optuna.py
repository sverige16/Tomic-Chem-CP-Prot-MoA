...
training_dataset_CS_CP_GE = CP_GE_Dataset(compound_df = cmpd_training_set, 
...
valid_dataset_CS_CP_GE = CP_GE_Dataset(compound_df =cmpd_validation_set, 
                                    ...
                                    dict_cell_line = dict_cell_lines, 
                                    images_H = images_H)
test_dataset_CS_CP_GE = CP_GE_Dataset(compound_df = cmpd_test_set, 
