...
class Datapreprocessing(object):
  ...
  def numeric_column_findout(self, dataset):
    ...
    with open(self.file_path, 'r') as infile, open("/home/jovyan/Tomics-CP-Chem-MoA/data_for_models/DWTM/ProcessedDataset_erik10_hq_8_12.csv", 'w') as outfile:
      fieldnames = keys
      writer = csv.DictWriter(outfile, fieldnames=fieldnames)
      writer.writeheader()
      for row in csv.DictReader(infile):
        writer.writerow(row)
    Processed_dataset = pd.read_csv("/home/jovyan/Tomics-CP-Chem-MoA/data_for_models/DWTM/ProcessedDataset_erik10_hq_8_12.csv")
