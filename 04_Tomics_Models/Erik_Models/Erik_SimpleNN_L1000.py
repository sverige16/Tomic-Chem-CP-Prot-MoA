...
batch_size = 50
WEIGHT_DECAY = 1e-5
learning_rate =  0.04556199943839492
num_feat = 0
# parameters
...
for fold_int in range(0,5):
    ...
    {'T_max': 10, 'alpha': 0.20730849127124368, 'dropout_l0': 0.24509543540660458, 'loss_fn': 'BCE', 'loss_train_fn': 'ols', 'lr': 0.04556199943839492, 'n_layers': 1, 'n_units_l0': 49, 'optimizer': 'RMSprop', 'scheduler': 'CosineAnnealingLR', 'smoothing': 0.24296117253545618, 'yn_class_weights': True}
    0.4388592483682342'''