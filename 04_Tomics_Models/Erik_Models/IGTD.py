...
norm_data = min_max_transform(df_train_features.values)
norm_data = pd.DataFrame(norm_data, columns = df_train_features.columns, index = df_train_features.index)
...
error = 'abs'
result_dir = '/scratch2-shared/erikep/Results/Test_1'
