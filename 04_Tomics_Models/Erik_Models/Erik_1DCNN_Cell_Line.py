...
for fold_int in range(0,5):
    ...
    cnn_model = CNN_Model(num_features = 978, num_targets = 15, hidden_size= hidden_size).to(device)



    model = Tomics_and_Cell_Line_Model(cnn_model, cell_line_model, num_targets = 10)
    ...
    model_test = Tomics_and_Cell_Line_Model(cnn_model, 
                                            cell_line_model, 
                                            num_targets = 10)
